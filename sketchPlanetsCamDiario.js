...
function setup() {
  ...
  //
  ii = -15 // dias anteriores 
  ifim = 15 // dias posteriores.
  //
  ...
  translate(0,0,0);
   ...
   if (ii++ < ifim) { //
    ...
    pop();
      ...
      strokeWeight(1);
      textFont(myfont, 43);
      text('w Piscium',width/2,0,0);
      //
      fill(111);
      strokeWeight(1);
      textFont(myfont, 30);
      text('4 Sagitarii',0,height/2,0);
      //
      fill(111);
      strokeWeight(1);
      textFont(myfont, 25);
  ...
  text(diaEHora1 + '\n' + diaEHora,posxj-150, posyj-90,0);
    ...
    zcam = 500 + 2000*exp(-frameCount/15);
    ...
    stereoX = stereoADist/2 * cos(stereoALong);
    stereoY = -stereoADist/2 * sin(stereoALong);
    fill('white');
    strokeWeight(1);
      textFont(myfont, 15);
