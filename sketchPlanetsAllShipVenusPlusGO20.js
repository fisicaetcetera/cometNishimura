...
function setup() {
  ...
  pop();
    ...
    posxrb1 = ox + factor * Xrb1; //x coordinate of asteroid rb1
    posyrb1 = oy - factor * Yrb1; //y coordinate of asteroid rb1
    poszrb1 = oy - factor * Zrb1; //y coordinate of asteroid rb1
  ...
  case 'mercury':
   ...
   pop();
    ...
    //Draws Rb1
    push();
    translate(posxrb1, posyrb1, poszrb1);
    //rotateX(PI / 2);
    //texture(marsjpg);
    fill('white');
    rm = raioMarte/4;
