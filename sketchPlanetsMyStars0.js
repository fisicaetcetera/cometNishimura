...
//constelações
  ...
  pop();
   ...
   posycam += deltay;
   rotabs = abs(rotatexx);
   camera.setPosition(1.7*posxe, 1.7*posye, posxe+posye);  // na eclítica além da Terra,=test
   camera.lookAt(0,0,0);  // para o Sol,
   ...
   //pop();
    ...
    rotateX(-PI/4);
     textFont(myfont, 40 );
  text('Programado em p5.js/WEBGL',50,0,0);
  }
