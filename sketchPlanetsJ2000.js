...
function Saturn() {
  //
  // Saturn's elements all in J2000
  ...
  e = 0.05386179;//rad
  L = 49.95424423;//deg
  q = 92.59887831;//lon per (wbar in table)

//Nasa's horizons equations

   m = L - q;//deg
   m = FNrange(m*degrad);
   m = m*degs;
   w = q - o; //arg of perihelion
   E = m - e*degs *sin(m);
   //Heliocentric coordinates
   Xsat = a*(cos(E) - e);
   Ysat = a*sqrt(1-e*e) * sin(E);
   Zsat = 0;

} //end of function Saturn
