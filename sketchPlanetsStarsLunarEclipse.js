...
//constelações
  ...
  pop();
   ...
   camz = 0;  
   camera(0.5*posxe,0.5*posye,0,posxe+posxmoon,posye+posymoon,poszmoon,0,-1,1,1);
    //sol
    push();
    fill('#dddd00');
    translate(ox, oy, 0);
