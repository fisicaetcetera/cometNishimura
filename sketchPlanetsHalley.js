...
function setup() {
  ...
  pop();
    ...
    posxj = ox + 100 * Xj; //x coordinate of jupiter
    posyj = oy - 100 * Yj; //y coordinate of jupiter
    posxv = ox + 100 * Xv; //x coordinate of Venus
    posyv = oy - 100 * Yv; //y coordinate of Venus
    posxSat = ox + 100 * XSat; //x coordinate of Saturn
    posySat = oy - 100 * YSat; //y coordinate of Saturn
    poszSat = oz - 100 * ZSat; //z coordinate of Saturn
    //
    posxUra = ox + 100 * Xura; //x coordinate of Uranus
    posyUra = oy - 100 * Yura; //y coordinate of Uranus
    poszUra = oz - 100 * Zura; //z coordinate of Uranus
